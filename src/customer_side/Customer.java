...
public class Customer {
	...
	/**
	 * Get encrypted certificate from the CA by sending the encrypted public key. Decrypt the certificate with the secret.
	 */
	public void requestCertificate(){
		certificateAuthority.issueCertificate(encryptPK());
	}
